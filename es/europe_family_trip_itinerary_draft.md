# Viaje Familiar a Europa — Itinerario (Borrador)

**Países Bajos · Bélgica · Luxemburgo · Francia**  
**Fechas (en destino):** 23 de marzo – 8 de abril de 2026 (salida de BOS tarde el 22 de marzo)  
**Viajeros:** 3 (2 adultos, 1 niño)
...
- Buscar/reservar hoteles en todas las paradas
...
## 🚆 Apps de tren (mejor tarifa)

Para mejor precio, **compra con el operador local** cuando se pueda; usa agregadores solo para comparar o por conveniencia.

- **NS** — Países Bajos (Ámsterdam, Eindhoven)
- **NS International** — Países Bajos ↔ Bélgica / Luxemburgo / Francia (cruces internacionales saliendo desde NL)
- **SNCB/NMBS** — Bélgica (Gante, Brujas)
...
**JetBlue Vuelo 0031**  
**Código de confirmación:** AXDECK

**Ida:**
- **Sale:** domingo 22 de marzo de 2026 a las 11:42 PM
- **Desde:** Boston Logan (BOS), Terminal C
- **Llega:** lunes 23 de marzo de 2026 a las 11:35 AM
- **A:** Ámsterdam Schiphol (AMS)

**Viajeros:**
1. **Christopher Wheeler**
   - TrueBlue #: 2508426473
   - Ticket #: 2792100922315
   - Tarifa: Blue Basic
   - Maletas: 1 incluida
...
3. **Ethan Wheeler** (niño)
   - TrueBlue #: (por agregar)
   - Ticket #: 2792100922317
   - Tarifa: Blue Basic
   - Maletas: 1 incluida

**Costo:**
- Tarjeta: $745.50
- (No reembolsable: $285.00, Impuestos y fees: $460.50)
- Pago: MasterCard terminada en 0880
- Fecha de compra: 8 de enero de 2026

**Notas:**
- Asientos: falta seleccionar asientos para todos
- Cada viajero puede agregar 1 maleta adicional ($100 c/u)
...
**Si hay energía (elige 1–2):**
- Caminata corta por canales cerca del hotel
- Cena temprana y casual

**Salida / descanso:** hotel + dormir

Nota:
- Meta: aguantar hasta ~8–9 pm hora local y reiniciar

---

## Día 2 — Ámsterdam (Mar, 24 Mar)
**Ámsterdam histórico + Ana Frank**

**Ancla (1):** Casa de Ana Frank (entrada con horario)
- No programar nada pesado antes
- Dejar espacio después

**Flexible (elige 2):**
- Caminata por Jordaan (ambiente “Amsterdam real”)
- Cinturón de canales (UNESCO): Herengracht / Keizersgracht
- Begijnhof (solo como “bonus” si les provoca repetir)

**Descanso / salida (1):** Crucero por canales (~1 hora)
- Perfecto para descomprimir después de Ana Frank

Nota:
- Este día queda lleno sin ser agotador

---

## Día 3 — Ámsterdam (Mié, 25 Mar)
**Ámsterdam al aire libre (sin tickets)**

**Ancla (suave):** Barrio de Museos / zona “I AMSTERDAM”
- Exterior del Rijksmuseum (fotos + caminar, cero presión)

**Flexible (elige 2):**
- Vondelpark (para que el niño corra + café cerca)
- Las Nueve Calles (De Negen Straatjes): tiendas, cafés, canales
- Mercado de flores flotante (con 10–15 min basta)

**Descanso / salida:** café + volver temprano + empacar con calma

**Opcional (según clima/ánimo — no reservado):**
- Si hace buen clima: alquilar bici 1–2 horas (solo parques, no tráfico pesado)
- Si llueve: Palacio Real por dentro (pequeño, fácil, central)

---

**Resumen 1-2-1 — Ámsterdam**

| Día | Ancla | Flexible | Descanso |
| --- | ----- | -------- | -------- |
| 23 Mar | Ninguna | Canales | Hotel |
| 24 Mar | Casa de Ana Frank | Jordaan, Canales | Crucero |
...
**Antes de la cena (opcional, elige 1):** caminata corta por el centro
- Markt
- Stratumseind (animado incluso temprano)
- 18 Septemberplein

**Descanso / salida:** noche temprana (o postre/trago en vez de plan largo)

Nota:
- Eindhoven es más de gente + Philips que de “turismo de lista”

---

## Día 5 — Eindhoven (Vie, 27 Mar)
**Philips + centro**

**Ancla (1):** Museo Philips (final de la mañana o inicio de la tarde)
- Planea ~1.5–2 horas

**Flexible (elige 2):**
- Vuelta por el centro (Demer + Kleine Berg para cafés/tiendas)
- Strijp-S (zona industrial Philips reutilizada, moderna)
- Stadswandelpark (si hay buen clima)

**Plan social opcional:** almuerzo/café/trago con compañeros (menos presión que otra cena)

**Descanso / salida:** empacar + cena temprano + noche tranquila

Nota:
- A propósito no metemos más museos / paseos largos para guardar energía para Bélgica

---

**Resumen 1-2-1 — Eindhoven**

| Día | Ancla | Flexible | Descanso |
| --- | ----- | -------- | -------- |
| 26 Mar | Cena con amigos | Caminata centro | Noche temprana |
| 27 Mar | Museo Philips | Strijp-S, centro | Empacar / descansar |

## 🇧🇪 Gante + Brujas — PLAN CERRADO (28–31 Mar)

**Filosofía (consejo local):**
- Gante = más local, más “vivido”, más cool
- Brujas = hermoso, histórico, y de comer/tomar
...
- Guardar maletas en la estación

**Gante (4–6 horas, sin afán)**

**Ancla (1):** Graslei & Korenlei
- Sentarse junto al agua y disfrutar

**Flexible (elige 2):**
- Caminar por el centro histórico (puentes + callejones)
- Almuerzo + café (según tu amiga):
  - Almuerzo: Nomad, De Republiek, Kaffee Kamiel
  - Café: Coffeebar Adriaan, Kottee Kaffee
- Tiempo en la orilla del río (snack + mirar gente)

**Opcional (solo adultos):** Het Druppelkot (máximo un trago)

**Noche:**
- Tren a Brujas (~30 min)
- Check-in + cena ligera + caminata nocturna

Nota:
- Gante es “una probadita”, no una lista

---

## Día 7 — Brujas (Dom, 29 Mar)
**Brujas — día completo (comida + ambiente)**

**Ancla (1):** caminar el casco histórico
- Plaza del Mercado + calles medievales + canales

**Flexible (elige 2):**
- Paseo en bote por canales (relajado, niño-friendly)
- Sint-Janshospitaal (hospital antiguo + farmacia + arte, sin agobio)
- Torre Belfort (opcional — muchas escaleras)

**Comida y bebida (según tu amiga):**
- Waffles: Otto Waffle Atelier, Chez Albert, Go.fre
- Chocolate (sin museos): The Chocolate Line, Pralinette, Spegelaere
- Cervecerías/cafés: Café De Garre, ’t Poatersgat
- Cervecería: De Halve Maan, Bourgogne des Flandres
- Vino: L’Aperovino
- Terraza: Lios (si el clima acompaña)

**Evitar:** ❌ Museo del Chocolate

**Descanso / salida:** solo cafés + noche temprana

---

## Día 8 — Brujas (Lun, 30 Mar)
**Día extra lento (buffer)**

**Ancla (suave):** Minnewater Park + Beguinage (tranquilo, bonito, caminable)

**Opcionales (elige 1–2):**
- Caminata a los molinos
- Volver a sus chocolates/waffles favoritos
- Café + compras de recuerditos
- Tour de cervecería (temprano)

**Opción “volver a Gante”:** si les encantó, medio día de regreso sin estrés

---

**Resumen 1-2-1 — Gante + Brujas**

| Día | Ancla | Flexible | Descanso |
| --- | ----- | -------- | -------- |
| 28 Mar | Graslei & Korenlei (Gante) | Comida/café, centro | Caminata nocturna |
| 29 Mar | Casco histórico (Brujas) | Bote, Sint-Janshospitaal | Cafés |
| 30 Mar | Minnewater / Beguinage | Molinos, chocolate | Tiempo libre |
...
Notas:
- Sin actividades con horario
- Primer día en Luxemburgo: corto y simple

---

## Día 10 — Luxemburgo (Mié, 1 Abr)
**Lo esencial de Luxemburgo**
- Casamatas (kid-friendly)
- Caminata por el valle Pétrusse
- Miradores del casco antiguo

Nota:
- Buen día para 2–3 cosas top sin correr

---

## Día 11 — Luxemburgo (Jue, 2 Abr)
**Día extra (elige 1)**
- Castillo de Vianden (clásico, muy familiar)
- Müllerthal Trail (caminata fácil, naturaleza)
- Día suave en la ciudad: cafés, parques, miradores, compras

Nota:
- Día “respiro” antes del tramo final en ciudad grande
...
## Día 14 — París (Dom, 5 Abr)
**Día de barrio (bajo estrés, alto disfrute)**
- Montmartre + Sacré-Cœur
- Crêpes / panadería + caminar sin afán
- Opcional: parque/juegos para mantener ritmo de niño
...
## Día 16 — París / Versalles (Mar, 7 Abr)
**Versalles**
- Tren a Versalles
...
Nota:
- Versalles cierra los lunes, así que martes encaja bien

---

## Día 17 — París (Mié, 8 Abr)
**Regreso**
- Check-out
...
## ✈️ Vuelo de regreso (confirmado)

**British Airways — confirmado (8 de abril de 2026)**

**Tramo 1:** BA0305 — British Airways (Euro Traveller)
- Mié, 8 Abr 2026 — **14:05** sale **Charles de Gaulle (París) — Terminal 2C**
- Mié, 8 Abr 2026 — **14:30** llega **Heathrow (Londres) — Terminal 5**

**Tramo 2:** BA0203 — British Airways (World Traveller)
- Mié, 8 Abr 2026 — **17:35** sale **Heathrow (Londres) — Terminal 5**
- Mié, 8 Abr 2026 — **20:05** llega **Logan International (Boston) — Terminal E**
...
**Pago:** EUR 1405.04 (Apple Pay) — emitido el **15 de enero de 2026**

**Pendientes / recordatorios:**
- Seleccionar asientos (si no están asignados)
- Confirmar equipaje por cabina + notas para niño
